...
public class KTYOPTION : MonoBehaviour
{
    ...
    [SerializeField]
    private GameObject GraphicInMenu = null;
    [SerializeField]
    private GameObject VolumeInMenu = null;
    [SerializeField]
    private GameObject InterfaceInMenu = null;

    [Header("비디오,볼륨,인터페이스 전환버튼")]
    [SerializeField]
    private GameObject Interface_BTN = null;
    [SerializeField]
    private GameObject Graphic_BTN = null;
    [SerializeField]
    private GameObject Volume_BTN = null;

    [Header("게임종료, 항복, 확인, 취소 버튼")]
    [SerializeField]
    private GameObject Confirm_Btn = null;
    [SerializeField]
    private GameObject ExitGame_Btn = null;
    [SerializeField]
    private GameObject Surrender_Btn = null;
    [SerializeField]
    private GameObject Cancel_Btn = null;
    [SerializeField]
    private GameObject Close_Btn = null;

    [Header("비디오 옵션 설정 버튼")]
    [SerializeField]
    private Slider GraphicQuality = null;
    [SerializeField]
    private Dropdown dropResolution = null;
    [SerializeField]
    private Dropdown dropWindow = null;
    [SerializeField]
    private GameObject DefaultGraphicButton = null;
    [SerializeField]
    private Text QulityViewText = null;
    ...
    [SerializeField]
    private GameObject volumeDefaultButton;
    [SerializeField]
    ...
    [SerializeField]
    private GameObject mvMute = null;
    [SerializeField]
    private GameObject sfxMute = null;
    [SerializeField]
    private GameObject bgmMute = null;
    ...
    [SerializeField]
    private AudioSource MasterAudio = null;

    [SerializeField]
    private GameObject ButtonLight = null;
    #endregion
